...
| # | 工作流 | 优先级 | 预计工期 | 关键里程碑 |
|---|-------|--------|---------|----------|
| 2.1 | 数据库集成 | 🔴 P0 | 3-5 天 | PostgreSQL + Prisma 运行 |
| 2.2 | E2E 测试框架 | 🟡 P1 | 2-3 天 | Playwright 测试运行 ✅ |
| 2.3 | API 持久化 | 🔴 P0 | 4-6 天 | 真实数据增删改查 |
| 2.4 | 优化与部署 | 🟡 P1 | 3-4 天 | 性能基准 + 安全加固 |
| 2.5 | 文档与交付 | 🟢 P2 | 1-2 天 | 完整文档 + 部署指南 |
