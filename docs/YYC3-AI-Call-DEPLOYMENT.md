...
本文档详细说明了YYC³ AI Intelligent Calling Center的部署流程和最佳实践。
...
# 应用配置
NODE_ENV=production
NEXT_PUBLIC_APP_NAME=YYC³ AI Intelligent Calling Center
...
- **GitHub Issues**: [项目 Issues 页面](https://github.com/YYC-Cube/yyc3-ai-call/issues)
- **文档**: [完整文档](https://docs.yyc3.com/ai-calling) 
